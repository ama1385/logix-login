...
let u,p
const h={},g={"/":"ââ",0:"ß",a:"â±¥ÉÉ",aa:"ê³",ae:"Ã¦Ç½Ç£",ao:"êµ",au:"ê·",av:"ê¹ê»",ay:"ê½",b:"ÆÉÆ",c:"ê¿ÆÈ¼â",d:"ÄÉÉá´Æê®·ÔÉ¦",e:"ÉÇá´É",f:"ê¼Æ",g:"Ç¥É ê¡áµ¹ê¿É¢",h:"Ä§â±¨â±¶É¥",i:"É¨Ä±",j:"ÉÈ·",k:"Æâ±ªêêêê£",l:"ÅÆÉ«â±¡êêêÉ­",m:"É±É¯Ï»",n:"ê¥ÆÉ²êá´Ð»Ô",o:"Ã¸Ç¿ÉÉµêêá´",oe:"Å",oi:"Æ£",oo:"ê",ou:"È£",p:"Æ¥áµ½êêêÏ",q:"êêÉ",r:"ÉÉ½êê§ê",s:"ÃÈ¿ê©êÊ",t:"Å§Æ­Êâ±¦ê",th:"Ã¾",tz:"ê©",u:"Ê",v:"ÊêÊ",vy:"ê¡",w:"â±³",y:"Æ´Éá»¿",z:"Æ¶È¥Éâ±¬ê£",hv:"Æ"}
for(let e in g){let t=g[e]||""
for(let s=0;s<t.length;s++){let i=t.substring(s,s+1)
h[i]=e}}const f=new RegExp(Object.keys(h).join("|")+"|[Ì-Í¯Â·Ê¾Ê¼]","gu"),m=(e,t="NFKD")=>e.normalize(t),v=e=>Array.from(e).reduce(((e,t)=>e+y(t)),""),y=e=>(e=m(e).toLowerCase().replace(f,(e=>h[e]||"")),m(e,"NFC"))
